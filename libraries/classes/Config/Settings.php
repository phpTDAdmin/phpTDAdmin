...
final class Settings
{
    ...
    public function __construct(array $settings)
    {
        ...
        $this->TDengineMinVersion = $this->setMysqlMinVersion($settings);
    ...
    {
        $mysqlMinVersion = ['internal' => 20000, 'human' => '2.0.0'];
        if (! isset($settings['TDengineMinVersion']) || ! is_array($settings['TDengineMinVersion'])) {
            return $mysqlMinVersion;
        }

        if (isset($settings['TDengineMinVersion']['internal'])) {
            $mysqlMinVersion['internal'] = (int) $settings['TDengineMinVersion']['internal'];
        }

        if (! isset($settings['TDengineMinVersion']['human'])) {
            return $mysqlMinVersion;
        }

        $mysqlMinVersion['human'] = (string) $settings['TDengineMinVersion']['human'];
